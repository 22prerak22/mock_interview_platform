...
Check out a live demo: [Demo Link](https://my-mock-interview-platform.vercel.app/)
...
Prepwise is a modern web platform for job interview preparation, built with Next.js, Firebase, TailwindCSS, and Vapi AI voice agents. It helps users practice interviews, receive instant AI feedback, and learn how to integrate AI models into applications.
...
- **Authentication**: Secure sign up/sign in via Firebase.
- **Create Interviews**: Generate interviews using Vapi voice assistants and Google Gemini.
- **AI Feedback**: Receive instant, structured feedback after each interview.
- **Modern UI/UX**: Responsive, user-friendly design.
- **Interview Page**: Real-time feedback and transcripts.
- **Dashboard**: Track and manage interviews.
- **Code Architecture**: Emphasis on reusability and maintainability.
